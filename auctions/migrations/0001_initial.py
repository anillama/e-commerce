# Generated by Django 3.1 on 2020-09-21 21:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='collectionMedia/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prodId', models.CharField(default=None, max_length=5)),
            ],
        ),
        migrations.CreateModel(
            name='WatchList',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('listItem', models.ManyToManyField(to='auctions.Auction')),
